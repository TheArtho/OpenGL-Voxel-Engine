...
namespace Tutorial
{
    public class Model : IDisposable
    {
        ...
        private List<Texture2D> _texturesLoaded = new List<Texture2D>();
        ...
        private unsafe List<Texture2D> LoadMaterialTextures(Material* mat, TextureType type, string typeName)
        {
